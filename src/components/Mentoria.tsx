...
export default function Mentoria() {
  return (
    <>
      ...
      <section className="bg-amp-cream py-24 sm:py-32">
        <div className="mx-auto max-w-content px-6 sm:px-8">
          <div className="grid grid-cols-1 items-start gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {categorias.map((categoria, index) => (
              <Reveal key={categoria.titulo} delay={index * 0.1}>
                <div className="flex flex-col items-start rounded-sm border border-amp-gold/40 bg-white/60 p-8 transition-colors duration-300 hover:border-amp-gold">
